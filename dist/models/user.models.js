...
var UserModel = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'INSERT INTO users (username,password_digest,first_name,last_name,email) values ($1,$2,$3,$4,$5) returning  id,username,first_name,last_name,email';
                        return [4 /*yield*/, conn.query(sql, [u.username, DigestPasword(u.password_digest), u.first_name, u.last_name, u.email])];
                    case 2:
                        result = _a.sent();
                        conn.release();
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new Error("Could not add new user ".concat(u.username, ". Error: ").concat(error_1));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = 'SELECT id,username,first_name,last_name,email FROM users WHERE id=($1)';
                        return [4 /*yield*/, database_1.default.connect()];
                    case 1:
                        conn = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not find user ".concat(u.username, ". Error: ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    UserModel.prototype.authenticateUser = function (e, password_digest) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, result, hash, isValid, info, err_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, conn.query('SELECT id,username,first_name,last_name,email FROM users where email=($1)', [e])];
                    case 3:
                        info = _a.sent();
                    ...
                    case 5:
                        err_5 = _a.sent();
                        throw new Error("Could not authenticate! Error: ".concat(err_5));
