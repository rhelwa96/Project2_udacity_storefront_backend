...
exports.updateSingle = exports.RetrieveSingle = exports.RetrieveAll = exports.deleteSingle = exports.create = void 0;
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, product_Model.create(req.body)];
            case 1:
                product = _a.sent();
...
var deleteSingle = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, product_Model.deleteSingle(req.params.id)];
            case 1:
                product = _a.sent();
                res.status(200).json(product);
                return [3 /*break*/, 3];
...
var RetrieveAll = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, product_Model.RetrieveAll()];
            case 1:
                products = _a.sent();
...
var RetrieveSingle = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, product_Model.RetrieveSingle(req.params.id)];
            case 1:
                product = _a.sent();
                res.status(200).json(product);
                return [3 /*break*/, 3];
...
var updateSingle = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, product_Model.updateSingle(req.body)];
            case 1:
                product = _a.sent();
                res.status(200).json(product);
                return [3 /*break*/, 3];
