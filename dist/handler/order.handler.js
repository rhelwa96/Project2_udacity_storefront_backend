...
exports.createOrder_Product = exports.updateSingle = exports.RetrieveSingle = exports.RetrieveAll = exports.deleteSingle = exports.create = void 0;
...
var createOrder_Product = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var order, err_6;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, order_Model.createOrder_Product(req.body)];
            case 1:
                order = _a.sent();
                res.json(order);
                return [3 /*break*/, 3];
